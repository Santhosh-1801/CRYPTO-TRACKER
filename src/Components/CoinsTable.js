...
import { CircularProgress, Container, LinearProgress, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, ThemeProvider, Typography, createTheme, makeStyles } from '@material-ui/core';
                  ...
                  return(
                    <TableRow onClick={()=>navigate(`/coins/${row.id}`)} className={classes.row} key={row.name}>
                        ...
                        <TableCell align='right'>
                          {symbol}{" "}{numberWithCommas(row.current_price.toFixed())}
                        </TableCell> 
                        <TableCell
                          align="right"
                          style={{
